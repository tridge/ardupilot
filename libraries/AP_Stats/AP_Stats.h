...
public:
    ...
    int32_t rem_flttime1; // Time remaining till first maintenance task
    int32_t rem_flttime2; // Time remaining till second maintenance task
...
private:
    ...
    struct {
        ...
        AP_Int32 runtime;
        AP_Int32 reset;
        AP_Int32 rem_flttime1;
        AP_Int32 rem_flttime2;
    } params;
