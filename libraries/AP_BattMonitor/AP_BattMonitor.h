...
public:
    ...
    /// set_pack_capacity_mah
    void set_pack_capacity_mah(const int32_t battery_capacity_mah, const uint8_t instance);
    void set_pack_capacity_mah(const int32_t battery_capacity_mah) { set_pack_capacity_mah(battery_capacity_mah, AP_BATT_PRIMARY_INSTANCE); }
    ...
    void display_voltage_only(uint8_t instance, bool display);
