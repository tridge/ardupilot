...
const AP_Param::GroupInfo AP_Logger::var_info[] = {
    ...
    // @Param: _FORCE_NOLOG
    // @DisplayName: Force disable logging
    // @Description: Flag to bypass all logging checks (disarmed, hard reboots, etc.) and prevent logging altogether.
    // @Values: 0:Let normal logging logic happen, 1:Forced it to not log
    // @User: Standard
    AP_GROUPINFO("_FORCE_NOLOG",  13, AP_Logger, _params.force_no_log, 0),
