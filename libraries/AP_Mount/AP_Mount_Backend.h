...
public:
    ...
    /*
        Ascent Aerosystems Mount Backend Functions
    */
    float get_camera_pan() { return _camera_pan_angle; }
    void align_roll_pitch_command_to_camera(float &target_roll, float &target_pitch);
    virtual void update_10hz() {}
    void set_cam_type(uint8_t cam){_cam = cam;}
    void set_gcs_type(uint8_t gcs){_gcs = (AP_Mount::GCSType)gcs;}
    void set_top_mount(uint8_t top){
        _topMount = top;
        if(_topMount){
            _centered_angle = 0;
		    _lookdown_angle = 0;
    ...
    virtual bool supports_ftc() const {return false;}
    virtual float get_zoom_level(){return 1.0;};
	virtual void look_down(){};
    virtual void stow(){};
    virtual void payload_take_picture(){};
    virtual void start_record(){};
    virtual void stop_record(){};
	virtual void toggle_heat(){};
    virtual void ir_full_screen(){};
    virtual void eo_full_screen(){};
    virtual void eo_ir(){};
    virtual void ir_eo(){};
   	virtual void digital_zoom_1(){};
    virtual void digital_zoom_2(){};
    virtual void digital_zoom_4(){};
    virtual void digital_zoom_8(){};
    virtual void digital_zoom_16(){};
    virtual void start_tracking(int x, int y){}; 
    virtual void stop_tracking(){}; 
    virtual void next_color_pallette(){};
    virtual void query_sd_info(){};
    virtual void yaw_follow_enable(){};
    virtual void yaw_follow_disable(){};
    virtual void set_gimbal_rates(float pan_speed, float tilt_speed){};
    virtual void set_zoom_rate(float zoom_speed){};
    virtual bool center_camera(bool follow_camera){return false;}
    virtual void toggle_detection(){};
    virtual void set_detection(int arg){};
    virtual void fusion(){};
    virtual void disable_eo_dzoom (){};
    virtual void enable_eo_dzoom (){};
    virtual void handle_v2_extension(const mavlink_message_t &msg) {};
    virtual void do_nuc(){};  
    virtual void trigger_menu_control(AP_Mount::GREMSY_MENU_CONTROL ctrl){};
    virtual void trigger_display(){};
    virtual void trigger_power(){};
    virtual void trigger_af(){};
    virtual void trigger_c1(){};
    virtual void trigger_c2(){};
    virtual void trigger_c3(){};
    virtual void trigger_mf_up(){};
    virtual void trigger_mf_down(){};
    virtual void trigger_wb_up(){};
    virtual void trigger_wb_down(){};
    virtual void trigger_speed_up(){};
    virtual void trigger_speed_down(){};
    virtual void trigger_aperture_up(){};
    virtual void trigger_aperture_down(){};
    virtual void trigger_iso_up(){};
    virtual void trigger_iso_down(){};
    virtual void trigger_expcorr_up(){};
    virtual void trigger_expcorr_down(){};
    virtual void trigger_zoom_up(){};
    virtual void trigger_zoom_down(){};
    virtual void trigger_focus_up(){};
    virtual void trigger_focus_down(){};
    virtual void start_geotagging(){};
    virtual void stop_geotagging(){};
    virtual void set_angles(float pan_input, float tilt_input){};
    virtual void handle_data64_extension(const mavlink_message_t &msg) {};
    virtual void handle_data16_extension(const mavlink_message_t &msg) {};
    virtual void handle_param_ext_value(const mavlink_message_t &msg) {};
    virtual void request_payload_info(){};
    virtual void set_osd_mode(int arg){};
    virtual void set_record_source(int arg){};
    virtual void set_zoom_mode(int arg){};
    virtual void ir_zoom(int arg){};
...
protected:
    ...
    /*
        Ascent Aerosystems Mount Variables
    */
    AP_Mount::GCSType _gcs = AP_Mount::GCS_Type_None;
    uint8_t _cam = 0;
    float _camera_tilt_angle;
    float _camera_pan_angle;
    float _camera_roll_angle;

    uint8_t _topMount = 0;
    uint8_t _centered_angle = 20;
    uint8_t _lookdown_angle = 90;

    float _prev_camera_pan_angle = 0.0;
    float _delta_camera_pan_angle = 0.0;
    float _camera_pan_rate = 0.0;
    uint32_t _feedback_timeout = 0;
};
