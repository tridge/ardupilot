...
const AP_Param::GroupInfo AP_MotorsMulticopter::var_info[] = {
    ...
    // @Param: Roll/Pitch lag
    // @DisplayName: 
    // @Description: Swashplate lag in radians
    // @Range: -3.14 3.14
    // @Units: rad
    // @User: Advanced
    AP_GROUPINFO("RP_LAG", 45, AP_MotorsMulticopter, _roll_pitch_lag_rad, AP_MOTORS_ROLL_PITCH_LAG_DEFAULT),
    ...
    // @Increment:
    // @User: Advanced
    AP_GROUPINFO("EN_RPM_COMP", 46, AP_MotorsMulticopter, _enable_rpm_comp, 0),
    ...
    // @Increment: 
    // @User: Advanced
    AP_GROUPINFO("RPM_DEADBAND", 47, AP_MotorsMulticopter, _rpm_deadband, 400),
    ...
    // @Increment: 
    // @User: Advanced
    AP_GROUPINFO("RPM_SCALE", 48, AP_MotorsMulticopter, _rpm_scale_factor, 0),
...
{
    if(_auto_motor_offsets){ return constrain_float(_spin_up_ratio, 0.0f, 1.0f) * AP_MOTORS_MODIFIED_ARM_SPIN; }
    else { return constrain_float(_spin_up_ratio, 0.0f, 1.0f) * thr_lin.get_spin_min(); }
}
