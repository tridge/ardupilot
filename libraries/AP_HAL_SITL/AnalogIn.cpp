...
float ADCSource::voltage_latest() {
    ...
    case 12: // NOT USED
        return (_sitlState->current2_pin_voltage/1024.0f);

    case 13: // NOT USED
        return (_sitlState->voltage2_pin_voltage/1024.0f);

    case 14:
        return (_sitlState->voltage_pin_voltage/1024.0f);

    case 15: // Divide by 1024 to re-scale. See SITL_State.cpp
        return (_sitlState->current_pin_voltage/1024.0f);
