...
// simulated sensor rates in Hz. First one is hard mounted, the other are vib. isolated
const uint16_t INS_SITL_SENSOR_A[] = { 1000, 700, 700 };
const uint16_t INS_SITL_SENSOR_B[] = { 1000, 700, 700 };
