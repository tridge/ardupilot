...
public:
  ...
  /*
     wipe out tiles that are not relevent to the current flight location. Called from user code.
    */
    void clear_unused_tiles(Location loc);
...
private:
    ...
    */
    ...
    // Toggle to true once done. Once per flight.
    bool clear_terrain_complete = false;
