...
public:
    ...
    void set_radius_cm_param(float radius_cm) { _radius_parm.set(radius_cm); }
...
private:
    ...
    float       _last_rate_param; // last value of rate param, used to update rate on param change
