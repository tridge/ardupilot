...
public:
    ...
    SIM() {
        ...
        AP_Param::setup_object_defaults(this, var_spirit);
#ifdef SFML_JOYSTICK
    ...
    static const struct AP_Param::GroupInfo var_spirit[];
#ifdef SFML_JOYSTICK
    ...
    AP_Float batt_res_ohm; // battery resistance in Ohm
    ...
    AP_Float core_mass_kg;
    AP_Float battery_number;
    AP_Float payload_weight_kg;
