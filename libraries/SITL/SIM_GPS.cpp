...
void GPS_MSP::update_write(const GPS_Data *d)
{
    ...
    msp_gps.satellites_in_view = d->num_sats;
...
void GPS::update()
{
    ...
    d.num_sats = have_lock?_sitl->gps_numsats[idx] : 3;
    d.latitude = latitude;
