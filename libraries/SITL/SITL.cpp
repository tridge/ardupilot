...
const AP_Param::GroupInfo SIM::var_info[] = {
    AP_SUBGROUPEXTENSION("", 4, SIM, var_spirit),
    ...
    // @Units: V
    // @User: Advanced
    AP_GROUPINFO("BATT_VOLTAGE",  19, SIM,  batt_voltage,  50.4f),
    AP_GROUPINFO("BATT_CAP_AH",   20, SIM,  batt_capacity_ah,  6.08),
    AP_GROUPINFO("BATT_RES_OHM",  21, SIM,  batt_res_ohm,  0.07),
...
// Spirit SITL parameters
const AP_Param::GroupInfo SIM::var_spirit[] = {
    AP_GROUPINFO("CORE_KG",          1, SIM, core_mass_kg,  2.33),
    AP_GROUPINFO("BATT_NUM",         2, SIM, battery_number, 1),
    AP_GROUPINFO("PAYLOAD_KG",       3, SIM, payload_weight_kg, 0),
    AP_GROUPEND
};
