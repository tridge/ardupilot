...
void NavEKF3_core::setAidingMode()
{
    ...
    switch (PV_AidingMode) {
        ...
        case AID_ABSOLUTE: {
            ...
            bool posUsed = (imuSampleTime_ms - lastGpsPosPassTime_ms <= minTestTime_ms) || (imuSampleTime_ms - lastExtNavPosPassTime_ms <= minTestTime_ms);
            ...
            if (!attAiding) {
            	attAidLossCritical = (imuSampleTime_ms - prevFlowFuseTime_ms > frontend->tiltDriftTimeMax_ms) &&
                        ...
                        (imuSampleTime_ms - lastExtNavPosPassTime_ms > frontend->tiltDriftTimeMax_ms) &&
...
void  NavEKF3_core::updateFilterStatus(void)
{
    ...
    status.flags.using_extnav = ((imuSampleTime_ms - lastExtNavPosPassTime_ms) < 4000) && (PV_AidingMode == AID_ABSOLUTE);
