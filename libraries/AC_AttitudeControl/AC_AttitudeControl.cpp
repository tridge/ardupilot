...
extern const AP_HAL::HAL& hal;
 ...
 #define AC_ATTITUDE_CONTROL_ANGLE_LIMIT_MIN     15.0   // Min lean angle so that vehicle can maintain limited control
#endif
...
const AP_Param::GroupInfo AC_AttitudeControl::var_info[] = {
    ...
    // @Param: PIRO_COMP
    // @DisplayName: Pirouette Compensation
    // @Description: Makes the attitude integrators in NE frame versus body frame
    // @Values: 0:Disabled, 1:Enabled
    // @User: Advanced
    AP_GROUPINFO("PIRO_COMP", 21, AC_AttitudeControl, _piro_comp_enabled, 1),
...
void AC_AttitudeControl::attitude_controller_run_quat()
{
    ...
    if (_thrust_error_angle > AC_ATTITUDE_THRUST_ERROR_ANGLE * 2.0f) {
        // TODO: no feedforward term added
        ...
        _ang_vel_body.z += ang_vel_body_feedforward.z * _feedforward_scalar;
        // TODO: revisit and compare to Ardupilot's original implementation
    } else {
        _ang_vel_body += ang_vel_body_feedforward * _feedforward_scalar;
    }
