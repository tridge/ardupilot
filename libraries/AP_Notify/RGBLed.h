...
protected:
    ...
    virtual bool hw_set_rgb(uint8_t red_1, uint8_t green_1, uint8_t blue_1, uint8_t red_2, uint8_t green_2, uint8_t blue_2);
...
#define WHITE (RED|GREEN|BLUE)
    ...
    const uint32_t sequence_no_RC_in_GPS = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(BLACK,YELLOW);
    const uint32_t sequence_no_RC_in_no_GPS = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(BLACK,YELLOW);
    ...
    const uint32_t sequence_arming_failed = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(BLACK, RED);
    const uint32_t sequence_flight_mode_change = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(BLACK, GREEN);
    const uint32_t sequence_flight_mode_change_fail = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(BLACK, YELLOW);
    const uint32_t sequence_low_servo_voltage = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(BLACK, RED);
