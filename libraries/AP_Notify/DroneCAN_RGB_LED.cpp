...
bool DroneCAN_RGB_LED::hw_set_rgb(uint8_t r_1, uint8_t g_1, uint8_t b_1, uint8_t r_2, uint8_t g_2, uint8_t b_2)
{
    uavcan_equipment_indication_LightsCommand msg {};
    msg.commands.len = 1;
    msg.commands.data[0].light_id =0;
    msg.commands.data[0].color.red = r_2 >> 3;
    msg.commands.data[0].color.green = g_2 >> 2;
    msg.commands.data[0].color.blue = b_2 >> 3;
