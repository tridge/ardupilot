...
#define ALL_NCP5623_I2C (Notify_LED_NCP5623_I2C_Internal | Notify_LED_NCP5623_I2C_External | Notify_LED_PCA9685LED_I2C_External)
#else
...
void AP_Notify::set_rgb_led_on_off(bool state) 
{
    if(state) _rgb_led_brightness.set(RGB_LED_HIGH);
    else _rgb_led_brightness.set(RGB_LED_OFF);
}
bool AP_Notify::get_rgb_led_on_off() const
{
    switch (_rgb_led_brightness) {
    default:
    case RGB_LED_OFF:
