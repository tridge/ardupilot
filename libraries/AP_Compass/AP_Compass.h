...
public:
    ...
    */
    ...
    void set_spirit_mot_correction_factor(const float factor) {
        _spirit_mot_correction_factor = factor;
    }
...
private:
    ...
    */
    ...
    // Correction to account for number of batteries that might change from operation to operation
    float _spirit_mot_correction_factor = 1.0f;
