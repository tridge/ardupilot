...
void ModeLoiter::run()
{
    ...
    if (!copter.failsafe.radio) {
        ...
        //Using a ViewPro camera in FTC mode and cam button is pressed. Vehicle yaw speed should be scaled with zoom
            ...
            //No else statement here because climb rate already defined at 0
        }
